...
if (NASA_WOO_ACTIVED) {
    ...
    class Nasa_Product_Brands_Widget extends WC_Widget {
        ...
        public function __construct() {
            ...
            $this->widget_description = __('Display product brands with Accordion.', 'nasa-core');
            $this->widget_id = 'nasa_product_brands';
            $this->widget_name = 'Nasa - Product Brands';
            $this->settings = array(
                'title' => array(
                    'type' => 'text',
                ...
                'accordion' => array(
                    'type' => 'checkbox',
                    'std' => 1,
                    'label' => __('Show as Accordion', 'nasa-core')
                ),
                'show_items' => array(
                    'type' => 'text',
                    'std' => 'All',
                    'label' => __('Show default numbers items', 'nasa-core')
                )
            );
