...
function nasa_sc_products_main($atts = array(), $content = null) {
    ...
    if (!$content) {
        ...
        if ($_total = $main->post_count) {
            ...
            ob_start();
            ?>
            <div class="woocommerce nasa-sc-main-extra-product<?php echo ($el_class != '') ? ' ' . esc_attr($el_class) : ''; ?>">
...
function nasa_register_products_main(){
    vc_map(array(
        "name" => "Products Main Extra",
        "base" => "nasa_products_main",
        'icon' => 'icon-wpb-nasatheme',
        'description' => __("Display 1 main and 4 extra products.", 'nasa-core'),
        "class" => "",
        "category" => 'Nasa Core',
        "params" => array(
            array(
                "type" => "dropdown",
                "heading" => __("Type Main", 'nasa-core'),
            ...
            array(
                "type" => "dropdown",
                "heading" => __("Type Extra", 'nasa-core'),
