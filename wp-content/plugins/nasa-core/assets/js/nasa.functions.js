            ...
            if (
                ...
                if ($(_add_wrap).hasClass('nasa-variable-add-to-cart-in-grid') && !$('body').hasClass('nasa-ywraq-hide-add-to-cart')) {
                    $(_add_wrap)
                        ...
                        if ($(_product_item).find('.nasa-loop-discount-slide').length) {
                            var _loop_discount = $(_product_item).find('.nasa-loop-discount-slide');
                            $(_loop_discount).find('.nasa-custom-animate').hide();
                            $(_loop_discount).find('.nasa-custom-animate[data-id="' + _variation_finded.variation_id + '"]').show();
                        }
                }
