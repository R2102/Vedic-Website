...
class cmb_Meta_Box_field {
     ...
     */
    public function __construct($field_args = array(), $group_field = null) {
     ...
     */
    public function _data($var = 'key', $key = '') {
        $vars = $this->$var;
        if ($key) {
     ...
     */
    public function update_data($new_value = array(), $single = true) {
    ...
    public function _set_field_defaults($args) {
        ...
        $args['inline'] = (isset($args['inline']) && $args['inline']) || (isset($args['type']) && $args['type'] && false !== stripos($args['type'], '_inline'));
