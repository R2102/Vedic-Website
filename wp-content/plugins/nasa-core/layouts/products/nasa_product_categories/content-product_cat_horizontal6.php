<?php
$class_slide = 'nasa-slick-slider nasa-slick-nav nasa-category-horizontal-6';
...
<div class="category-slider nasa-category-slider-horizontal-6 nasa-category-slider-horizontal<?php echo esc_attr($el_class); ?>">
