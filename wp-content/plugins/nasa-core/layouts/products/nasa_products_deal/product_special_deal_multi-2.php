        ...
        <div class="main-border-wrap">
            <div class="nasa-main-special nasa-slider-wrap">
                <div class="nasa-main-top">
                    ...
                    <?php if ($arrows == 1) : ?>
                        <div class="nasa-nav-slick-wrap nasa-transition nasa-invisible-loading nasa-flex" data-id="#nasa-slider-slick-<?php echo esc_attr($sc); ?>">
                            <a class="nasa-nav-icon-slick nasa-nav-prev nasa-flex" href="javascript:void(0);" data-do="prev" rel="nofollow">
                                <svg width="30" height="30" viewBox="0 0 32 32" fill="currentColor">
                                    <path d="M12.792 15.233l-0.754 0.754 6.035 6.035 0.754-0.754-5.281-5.281 5.256-5.256-0.754-0.754-3.013 3.013z" />
                                </svg>
                                <span class="nasa-text hide-for-small"><?php echo esc_html__('Prev Deal', 'nasa-core'); ?></span>
                            </a>
                            <a class="nasa-nav-icon-slick nasa-nav-next nasa-flex" href="javascript:void(0);" data-do="next" rel="nofollow">
                                <span class="nasa-text hide-for-small"><?php echo esc_html__('Next Deal', 'nasa-core'); ?></span>
                                <svg width="30" height="30" viewBox="0 0 32 32" fill="currentColor">
