...
<div class="row">
    <div class="nasa-main-special nasa-main-nav-2-items nasa-slider-wrap large-9 medium-9 columns rtl-right">
        <?php if ($arrows == 1) : ?>
            <div class="nasa-nav-slick-wrap nasa-transition nasa-invisible-loading nasa-flex">
                <div class="nasa-nav-slick-prev nasa-nav-slick-div nasa-flex">
                    <a class="nasa-nav-icon-slick nasa-flex" href="javascript:void(0);" data-do="prev" rel="nofollow">
                        <svg width="35" height="35" viewBox="0 0 32 32" fill="currentColor">
                            <path d="M12.792 15.233l-0.754 0.754 6.035 6.035 0.754-0.754-5.281-5.281 5.256-5.256-0.754-0.754-3.013 3.013z" />
                        </svg>
                        <?php echo esc_html__('Prev Deal', 'nasa-core'); ?>
                    </a>
                </div>
                <div class="nasa-nav-slick-next nasa-nav-slick-div nasa-flex">
                    <a class="nasa-nav-icon-slick nasa-flex" href="javascript:void(0);" data-do="next" rel="nofollow">
                        <?php echo esc_html__('Next Deal', 'nasa-core'); ?>
                        <svg width="35" height="35" viewBox="0 0 32 32" fill="currentColor">
