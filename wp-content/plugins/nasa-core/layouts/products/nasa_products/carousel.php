<?php
$layout_buttons_class = !isset($layout_buttons_class) ? '' : $layout_buttons_class;
if (isset($nasa_opt['loop_layout_buttons']) && $nasa_opt['loop_layout_buttons'] != '' && !$layout_buttons_class) :
