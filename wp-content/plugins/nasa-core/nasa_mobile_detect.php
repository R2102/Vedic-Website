...
function nasa_check_is_phone() {
    global $nasa_is_phone, $nasa_is_iphone;
    ...
    if (!isset($nasa_is_phone)) {
        ...
        if ($nasa_is_phone) {
            $nasa_is_iphone = $nasa_mobile_detect->is('iphone') ? true : false;
            $GLOBALS['nasa_is_iphone'] = apply_filters('nasa_is_iphone', $nasa_is_iphone, $nasa_mobile_detect);
        }
