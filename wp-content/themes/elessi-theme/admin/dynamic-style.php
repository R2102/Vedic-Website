...
function elessi_get_content_custom_css($nasa_opt = array()) {
    ...
    echo elessi_get_var_settings($nasa_opt, true);
    ...
    if (isset($nasa_opt['color_button']) && $nasa_opt['color_button'] != '') :
        ?>
            ...
            .nasa-content-page-products .products.list .product-item .group-btn-in-list .add-to-cart-grid .add_to_cart_text
            {
    ...
    if (isset($nasa_opt['color_hover']) && $nasa_opt['color_hover'] != '') :
        ?>
            ...
            .nasa-content-page-products .products.list .product-item .group-btn-in-list .add-to-cart-grid:hover .add_to_cart_text
            {
    ...
    if (isset($nasa_opt['input_radius'])) :
        ?>
            ...
            .header-type-8 .nasa-search-space .nasa-show-search-form.nasa-search-relative
            {
