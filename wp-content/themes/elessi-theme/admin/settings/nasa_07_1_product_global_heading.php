...
if (!function_exists('elessi_product_global_heading')) {
    function elessi_product_global_heading()
    {
        ...
        $of_options[] = array(
            "name" => __("Discount Announcement Slide", 'elessi-theme'),
            "id" => "loop_discount_slide",
            "std" => "0",
            "type" => "switch"
        );

        $of_options[] = array(
            "name" => __('Discount Announcement Slide - Text', 'nasa-core'),
            "id" => "loop_discount_slide_text",
            "std" => "",
            "type" => "text",
            "desc" => "Text displayed in slide (Ex:'HOT SALE {sale} OFF' => 'HOT SALE 20% OFF')",
            'child_of' => 'loop_discount_slide',
            'm_target' => '1',
        );

        $of_options[] = array(
            "name" => __("Discount Announcement Slide - Text Color", 'elessi-theme'),
            "id" => "loop_discount_slide_color",
            "std" => "",
            "type" => "color",
            'child_of' => 'loop_discount_slide',
            'm_target' => '1',
        ...
        $of_options[] = array(
            "name" => __("Discount Announcement Slide - Background Color", 'elessi-theme'),
            "id" => "loop_discount_slide_bg_color",
            "std" => "",
            "type" => "color",
            'child_of' => 'loop_discount_slide',
            'm_target' => '1',
        ...
        $of_options[] = array(
            "name" => __("Discount Announcement Slide - SVG", 'elessi-theme'),
            "desc" => 'Add svg yourself',
            "id" => "loop_discount_slide_svg",
            "std" => '',
            "type" => "textarea",
            'child_of' => 'loop_discount_slide',
            'm_target' => '1',
        ...
        $of_options[] = array(
            "name" => __("Discount Announcement Slide - SVG Color", 'elessi-theme'),
            "id" => "loop_discount_slide_svg_color",
            "std" => "",
            "type" => "color",
            'child_of' => 'loop_discount_slide',
            'm_target' => '1',
        ...
        $of_options[] = array(
            "name" => "Mini Cart - Disable notification feature before removing products from cart",
            "id" => "mini_cart_disable_noti_remove",
            "std" => "0",
            "type" => "switch",
        );
        ...
        $of_options[] = array(
            "name" => __("Coupon - Options", 'elessi-theme'),
            "std" => "<h4>" . __("Coupon - Options", 'elessi-theme') . "</h4>",
            "type" => "info"
        );

        $of_options[] = array(
            "name" => __("Coupon - Display Style", 'elessi-theme'),
            "id" => "coupon_display_style",
            "std" => "",
            "type" => "select",
            "options" => array(
                'style-1' => __('Style 1', 'elessi-theme'),
                'style-2' => __('Style 2', 'elessi-theme')
            )
        );

        $of_options[] = array(
            "name" => __("Coupon - Hide Expired", 'elessi-theme'),
            "id" => "coupon_exp_hide",
            "std" => "0",
            "type" => "switch"
        );
        ...
        $of_options[] = array(
            "name" => __("Coupon - Hide Applied", 'elessi-theme'),
            "id" => "coupon_applied_hide",
            "std" => "0",
            "type" => "switch"
        );

        $of_options[] = array(
            "name" => __("Coupon - Display Background Color", 'elessi-theme'),
            "id" => "coupon_display_bg",
            "std" => "",
            "type" => "color",
            'child_of' => 'coupon_display_style',
            'm_target' => 'style-2',
        );

        $of_options[] = array(
            "name" => __("Coupon - Display Background Color - Hover", 'elessi-theme'),
            "id" => "coupon_display_bg_hover",
            "std" => "",
            "type" => "color",
            'child_of' => 'coupon_display_style',
            'm_target' => 'style-2',
        ...
        $of_options[] = array(
            "name" => __("Coupon - Display Text Color", 'elessi-theme'),
            "id" => "coupon_display_text_color",
            "std" => "",
            "type" => "color",
            'child_of' => 'coupon_display_style',
            'm_target' => 'style-2',
        ...
        $of_options[] = array(
            "name" => __("Coupons - Public - Mini Cart, Check Out (one per line)", 'elessi-theme'),
        ...
        $of_options[] = array(
            "name" => __("Coupon - Mini Cart", 'elessi-theme'),
            "id" => "mini_cart_coupon",
            "std" => "0",
            "type" => "switch"
        );
        ...
        $of_options[] = array(
            "name" => __("Coupon - Checkout Page", 'elessi-theme'),
            "id" => "checkout_coupon",
            "std" => "1",
            "type" => "switch",
        );
        ...
        $of_options[] = array(
            "name" => __("Coupon - Single Product", 'elessi-theme'),
            "id" => "single_coupon",
            "std" => "0",
            "type" => "switch",
        );
        ...
        $of_options[] = array(
            "name" => __("Coupons - Single Product - Public Product (one per line)", 'elessi-theme'),
            "desc" => 'Please input the coupon code you want to publish in Single Product (one per line).',
            "id" => "single_p_coupon",
            "std" => '',
            "type" => "textarea",
            'child_of' => 'single_coupon',
            'm_target' => '1',
        );
        ...
        $of_options[] = array(
            "name" => __("Sale Badge", 'elessi-theme'),
            "id" => "sale_badge",
            "std" => "1",
            "type" => "switch"
        );
        ...
        $of_options[] = array(
            "name" => __("Out Of Stock Badge", 'elessi-theme'),
            "id" => "outofstock_badge",
            "std" => "1",
            "type" => "switch"
        );
