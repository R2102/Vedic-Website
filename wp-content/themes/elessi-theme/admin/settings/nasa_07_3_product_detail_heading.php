...
if (!function_exists('elessi_product_detail_heading')) {
    function elessi_product_detail_heading() {
        ...
        $of_options[] = array(
            "name" => __("Reverse Layout", 'elessi-theme'),
            "id" => "reverse_layout",
            "std" => "0",
            "type" => "switch",
            'child_of' => 'product_detail_layout',
            'm_target' => array('new-3'),
        );
        ...
        $of_options[] = array(
            "name" => __("Read More Short Description", 'elessi-theme'),
            "id" => "enable_read_more_short_description",
            "desc" => __("Focus main image after active variation product", 'elessi-theme'),
            "std" => "0",
            "type" => "switch"
        );
        ...
        $of_options[] = array(
            "name" => __("Read More Short Description - Height", 'elessi-theme'),
            "id" => "height_rm_short_desc",
            "std" => "50",
            "type" => "text",
            'child_of' => 'enable_read_more_short_description',
            'm_target' => '1',
        );
        ...
        $of_options[] = array(
            "name" => __("Deal Time in Single and Quickview", 'elessi-theme'),
