...
function nasa_wpb_organic_4() {
    ...
    $imgs_url_src_1 = $imgs_url_1 ? wp_get_attachment_image_url($imgs_url_1, 'full') : 'https://dummyimage.com/1920x894?text=1920x894';
    ...
    $imgs_url_src_2 = $imgs_url_2 ? wp_get_attachment_image_url($imgs_url_2, 'full') : 'https://dummyimage.com/1920x170?text=1920x170';
