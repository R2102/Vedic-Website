...
function nasa_wpb_organic_2() {
    ...
    $imgs_url_src = $imgs_url ? wp_get_attachment_image_url($imgs_url, 'full') : 'https://dummyimage.com/1920x560?text=1920x560';
    ...
    $imgs_3 = elessi_import_upload('/wp-content/uploads/2022/06/organic22-banner.jpg', '3108', array(
        'post_title' => 'organic2-banner',
        'post_name' => 'organic2-banner',
    ));
