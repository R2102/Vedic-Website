...
if (!function_exists('elessi_static_block_popup')) :
    function elessi_static_block_popup()
    {
        ...
        if ($object) {
            ...
            $custom_popup = in_array($custom_header, array('4', '6', '8')) ? get_post_meta($object_id, '_nasa_popup_static_block', true) : '';
            $popup = isset($custom_popup) && $custom_popup != '' ? $custom_popup : $popup;
        }

        $root_cat_id = elessi_get_root_term_id();
        if ($root_cat_id) {
            $custom_header = get_term_meta($root_cat_id, 'cat_header_type', true);
            $custom_popup = in_array($custom_header, array('4', '6', '8')) ? get_term_meta($root_cat_id, 'cat_popup_static_block', true) : '';
            $popup = isset($custom_popup) && $custom_popup != '' ? $custom_popup : $popup;
        }

        return !$popup || in_array($popup, array('', 'select', 'default')) ? '' : elessi_get_block($popup);
    }
endif;
...
if (!function_exists('elessi_get_header_structure')):
    function elessi_get_header_structure()
    {
        ...
        if (in_array($hstructure, array(6, 8))) {
...
if (!function_exists('elessi_header_icons')) :
    function elessi_header_icons($product_cat = true, $cart = true, $compare = true, $wishlist = true, $search = true)
    {
        ...
        if ($account_icon) {
            ...
            $class = !$first && $hstructure != '8' ? 'first ' : '';
            $first = $hstructure != '8' ? true : $first;
...
if (!function_exists('elessi_left_header_mobile_df')) :
    function elessi_left_header_mobile_df()
    {
        ...
        echo '<a href="javascript:void(0);" aria-label="' . esc_html__('Toggle mobile menu', 'elessi-theme') . '" class="nasa-icon nasa-mobile-menu_toggle mobile_toggle nasa-mobile-menu-icon nasa-flex" rel="nofollow">' . $menu_svg . '</a>';

        echo '<a class="nasa-icon mobile-search" href="javascript:void(0);" rel="nofollow" aria-label="' . esc_html__('Mobile search', 'elessi-theme') . '">' . $search_svg . '</a>';
    }
endif;
...
if (!function_exists('elessi_left_header_mobile_app')) :
    function elessi_left_header_mobile_app()
    {
        ...
        if (NASA_WOO_ACTIVED && is_product()) {
            ...
            echo '<a href="javascript:void(0);" aria-label="' . esc_html__('Toggle mobile menu', 'elessi-theme') . '" class="nasa-icon nasa-mobile-menu_toggle mobile_toggle nasa-mobile-menu-icon nasa-flex" rel="nofollow"><svg width="26" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"><line x1="3" y1="12" x2="21" y2="12" /><line x1="3" y1="6" x2="21" y2="6" /><line x1="3" y1="18" x2="21" y2="18" /></svg></a>';
        }
    }
endif;
...
if (!function_exists('elessi_left_header_mobile_rp')) :
    function elessi_left_header_mobile_rp()
    {
        ...
        echo '<a href="javascript:void(0);" aria-label="' . esc_html__('Toggle mobile search', 'elessi-theme') . '" class="nasa-icon mobile-search fs-23" rel="nofollow"><svg fill="currentColor" viewBox="0 0 80 80" width="22" height="22"><path d="M74.3,72.2L58.7,56.5C69.9,44,69,24.8,56.5,13.5s-31.7-10.3-43,2.2s-10.3,31.7,2.2,43c11.6,10.5,29.3,10.5,40.9,0 l15.7,15.7L74.3,72.2z M36.1,63.5c-15.1,0-27.4-12.3-27.4-27.4C8.7,20.9,21,8.7,36.1,8.7c15.1,0,27.4,12.3,27.4,27.4 C63.5,51.2,51.2,63.5,36.1,63.5z"/><path d="M36.1,12.8v3c11.2,0,20.3,9.1,20.3,20.3h3C59.4,23.2,49,12.8,36.1,12.8z" /></svg></a>';
    }
endif;
