...
if (!function_exists('elessi_get_style_main_menu_color')) :
    ...
    function elessi_get_style_main_menu_color(
        ...
        ?><style>
            ...
            if ($text_color != '') :
                ?>
                .nasa-beside-mm >div:first-child,
                .nasa-beside-mm >div:first-child a,
                .nasa-beside-mm >div:first-child a:hover,
            ...
            if ($text_color_stk != '') :
                ?>
                .fixed-already .nasa-beside-mm >div:first-child,
                .fixed-already .nasa-beside-mm >div:first-child a,
                .fixed-already .nasa-beside-mm >div:first-child a:hover,
 ...
 */
if (!function_exists('elessi_get_var_settings')) :
    function elessi_get_var_settings($nasa_opt, $return = true) {

        //Override setting
        $settings = [
            'coupon_display_bg'             => elessi_get_value($nasa_opt, 'coupon_display_bg', '#efefef'),
            'coupon_display_bg_hover'       => elessi_get_value($nasa_opt, 'coupon_display_bg_hover', '#ececec'),
            'coupon_display_text_color'     => elessi_get_value($nasa_opt, 'coupon_display_text_color', 'inherit'),
            
            // fallback for dark mode
            'coupon_display_bg_dark'        => elessi_get_value($nasa_opt, 'coupon_display_bg', '#555'),
            'coupon_display_bg_hover_dark'  => elessi_get_value($nasa_opt, 'coupon_display_bg_hover', '#222'),
            'coupon_display_text_color_dark'=> elessi_get_value($nasa_opt, 'coupon_display_text_color', '#c1c1c1'),

            'loop_discount_slide_bg_color'   => elessi_get_value($nasa_opt, 'loop_discount_slide_bg_color', '#000000'),
            'loop_discount_slide_color'      => elessi_get_value($nasa_opt, 'loop_discount_slide_color', '#ffffff'),
            'loop_discount_slide_svg_color'  => elessi_get_value($nasa_opt, 'loop_discount_slide_svg_color', '#f76b6a'),

            'height_rm_short_desc'  => (int) elessi_get_value($nasa_opt, 'height_rm_short_desc', '50'),

            'sp_bgl' => elessi_get_value($nasa_opt, 'sp_bgl', 'inherit'),
        ];
        ...
        <style>
            :root {
                --coupon_display_bg: <?php echo esc_attr($settings['coupon_display_bg']); ?>;
                --coupon_display_bg_hover: <?php echo esc_attr($settings['coupon_display_bg_hover']); ?>;
                --coupon_display_text_color: <?php echo esc_attr($settings['coupon_display_text_color']); ?>;
                --loop_discount_slide_bg_color: <?php echo esc_attr($settings['loop_discount_slide_bg_color']); ?>;
                --loop_discount_slide_color: <?php echo esc_attr($settings['loop_discount_slide_color']); ?>;
                --loop_discount_slide_svg_color: <?php echo esc_attr($settings['loop_discount_slide_svg_color']); ?>;
                --height_rm_short_desc: <?php echo esc_attr((int) $settings['height_rm_short_desc']); ?>px;
                --shadow-read-more-btn-color: <?php echo esc_attr($settings['sp_bgl']); ?>;
            }

            body.nasa-dark {
                --coupon_display_bg: <?php echo esc_attr($settings['coupon_display_bg_dark']); ?>;
                --coupon_display_bg_hover: <?php echo esc_attr($settings['coupon_display_bg_hover_dark']); ?>;
                --coupon_display_text_color: <?php echo esc_attr($settings['coupon_display_text_color_dark']); ?>;
            }
        </style>
...
if (!function_exists('elessi_get_value')) :
    function elessi_get_value($nasa_opt, $key, $default) {
