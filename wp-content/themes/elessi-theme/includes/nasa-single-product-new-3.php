...
$left = isset($nasa_opt['reverse_layout']) && $nasa_opt['reverse_layout'] ? 'right' : 'left' ;
$right = isset($nasa_opt['reverse_layout']) && $nasa_opt['reverse_layout'] ? 'left' : 'right' ;
    ...
    <div class="nasa-row nasa-product-details-page modern nasa-layout-new-3">
        <div<?php echo !empty($main_attrs) ? ' ' . implode(' ', $main_attrs) : ''; ?>>
            ...
            <div class="row focus-info">
                <div class="large-7 small-12 columns product-gallery rtl-<?php esc_attr_e($left)?> <?php esc_attr_e($right)?> desktop-margin-bottom-60 <?php echo $is_tab_small_accordion ; ?>"> 
                    <?php do_action('woocommerce_before_single_product_summary'); ?>
                </div>

                <div class="large-5 small-12 columns product-info summary entry-summary rtl-<?php esc_attr_e($right)?> <?php esc_attr_e($left)?> desktop-padding-<?php esc_attr_e($right)?>-30 rtl-desktop-padding-<?php esc_attr_e($right)?>-10 rtl-desktop-padding-<?php esc_attr_e($left)?>-30 tablet-padding-<?php esc_attr_e($right)?>-10 rtl-tablet-padding-<?php esc_attr_e($left)?>-10">
                ...
                <div class="large-7 small-12 columns nasa-product-details-wrap rtl-<?php esc_attr_e($left)?> <?php esc_attr_e($right)?> margin-bottom-40<?php echo $is_tab_small_accordion ; ?>"> 
                    <?php do_action('woocommerce_after_single_product_summary'); ?>
                </div>

                <div class="large-7 small-12 columns nasa-product-extend-tab-wrap rtl-<?php esc_attr_e($left)?> <?php esc_attr_e($right)?>">
