...
<div class="<?php echo esc_attr($quantily_class); ?>">
    ...
    <?php if (!$readonly && $type != 'hidden') : ?>
        <a href="javascript:void(0);" class="plus" rel="nofollow" aria-label="<?php echo esc_html('Plus','elessi-theme')?>">
    ...
    <?php if (!$readonly && $type != 'hidden') : ?>
        <a href="javascript:void(0);" class="minus" rel="nofollow" aria-label="<?php echo esc_html('Minus','elessi-theme')?>">
            <svg width="13" height="20" stroke-width="2" viewBox="0 0 24 24" fill="currentColor">
                <path d="M6 12H18" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
        </a>
